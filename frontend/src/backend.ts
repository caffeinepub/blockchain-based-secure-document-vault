...
import type { Document as _Document, ExternalBlob as _ExternalBlob, _CaffeineStorageRefillInformation as __CaffeineStorageRefillInformation, _CaffeineStorageRefillResult as __CaffeineStorageRefillResult } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async addDocument(arg0: ExternalBlob, arg1: string, arg2: string, arg3: bigint): Promise<Document> {
        if (this.processError) {
            try {
                const result = await this.actor.addDocument(await to_candid_ExternalBlob_n8(this._uploadFile, this._downloadFile, arg0), arg1, arg2, arg3);
    ...
    async getMyDocumentIds(arg0: boolean): Promise<Array<Document>> {
        if (this.processError) {
            try {
                const result = await this.actor.getMyDocumentIds(arg0);
